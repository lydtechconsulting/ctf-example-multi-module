...
public class EndToEndComponentTest {

    private static final String GROUP_ID = "EndToEndCT";
    private final static String INBOUND_TOPIC = "ctf-example-mm-inbound-topic";
    private final static String OUTBOUND_TOPIC = "ctf-example-mm-outbound-topic";
     ...
     *
     * This test therefore verifies Kafka and Simulator containers are working as required.
     */
    @Test
